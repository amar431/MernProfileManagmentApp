...
import AdminAccountActivation from "./components/admin/pages/AdminAccountActivation";
    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route
          ...
          element={<Activation />}
        />
        <Route path="/admin/login/activate/:activationToken"
        element={<AdminAccountActivation/>}
        />
